...
VALUES (
    ...
    sqlc.narg(job_url),
    sqlc.narg(portal_account),
    sqlc.narg(portal_password),
...
SET
    ...
    portal_account = COALESCE(sqlc.narg(portal_account), portal_account),
    portal_password = COALESCE(sqlc.narg(portal_password), portal_password),
