...
import {
  APPLICATION_STATUS_CHART_COLORS,
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-neutral-500">
          Application funnel and performance
        </p>
      </div>
          ...
          <div className="space-y-2">
            {funnel.map((step) => (
              <Bar
                key={step.stage}
                label={
                  APPLICATION_STATUS_LABELS[step.stage] ??
...
function ChartCard({
  ...
  return (
    <div className="rounded-lg border border-neutral-200 bg-white">
      <h2 className="px-5 py-3.5 text-sm font-semibold text-neutral-700 border-b border-neutral-100">
        {title}
      </h2>
...
function Bar({
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="w-36 shrink-0 text-xs text-neutral-500 capitalize truncate">
        {label}
      </span>
      ...
      <span className="w-8 text-right text-xs font-semibold text-neutral-600">
        {value}
      </span>
    </div>
  );
